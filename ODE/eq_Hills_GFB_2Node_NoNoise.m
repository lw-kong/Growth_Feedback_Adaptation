function dxdt = eq_Hills_GFB_2Node_NoNoise(~,x,input,k_node,k_linkfull,k_growth,J)
...
dxdt(1) = k_node(1,1) * func_Hills(input,k_linkfull(1,2,:)) * ...
                    func_Hills(x(1),k_linkfull(2,2,:)) * ...
                    func_Hills(x(2),k_linkfull(3,2,:)) - (k_node(1,2)+dxdt(end)) * x(1);
dxdt(2) = k_node(2,1) * ...
                    func_Hills(x(1),k_linkfull(2,3,:)) * ...
                    func_Hills(x(2),k_linkfull(3,3,:)) - (k_node(2,2)+dxdt(end)) * x(2); % output
